...
<head>
  ...
  <title>RJT Store Inventory - Login     </title>
      ...
      <div class="col-md-8 bg-login h-100">
        <div class="login-illustration h-100">
          <div class="login-flex">
            ...
            <h5 class="greeting">Selamat Datang di <br><span>Aplikasi Inventory Barang</span></h5>
          ...
          <div class="mt-3">
            <div class="">
              <form action="<?php echo base_url();?>auth/login" method="post" id="form-login">
                ...
                <button class="btn btn-darkblue btn-block" style="background: black !important;" id="btn-login">Login</button>
              </form>
              <div class="row">
                <!-- <div class="col-12">
