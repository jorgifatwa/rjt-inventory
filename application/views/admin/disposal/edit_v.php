                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <select name="production" id="production" class="form-control">
                                        ...
                                        <option <?php if ($production == 1) {echo "selected";}?> value="1">OB Production</option>
                                        <option <?php if ($production == 2) {echo "selected";}?> value="2">Coal Production</option>
                                        <option <?php if ($production == 3) {echo "selected";}?> value="3">Fuel</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" type="text" id="name" name="name" autocomplete="off" required placeholder="Nama Disposal" value="<?php echo $name; ?>">
                                </div>
                            </div>
                        </div>
                    </div>
