<section class="content-header">
    <h1>
        Fuel Stock
        <small>Fuel Stock Baru</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo base_url() ?>location"></i>Fuel Stock</a></li>
        <li class="active">Fuel Stock Baru</li>
    </ol>
</section>
        ...
        <form id="form" method="post">
            <div class="box-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="waktu" name="waktu" autocomplete="off" placeholder="Waktu">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <div class="input-group">
                            <input type="text" class="form-control number" id="nilai" name="nilai" autocomplete="off" placeholder="Nilai">
