            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select name="loading_unit_id" id="loading_unit_id" class="form-control">
                        ...
                        <option value="<?php echo $loading->id;?>"><?php echo $loading->kode."--".$loading->unit_model_name."--".$loading->unit_type_name;?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-6 text-right">
          <?php if($is_can_create){ ?>
            <a href="<?php echo base_url()?>hours_meter/create" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Hours Meter</a>
          <?php } ?>
        </div>
      </div>
    </div>
