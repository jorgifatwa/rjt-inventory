    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Set Joki</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
...
<script data-main="<?php echo base_url() ?>assets/js/main/main-set-joki" src="<?php echo base_url() ?>assets/js/require.js"></script>