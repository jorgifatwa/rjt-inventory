                ...
                <div class="row">
                    <div class="col-sm-12 text-right">
                        <?php if ($is_can_create) {?>
                            <a href="<?php echo base_url() ?>seam/create" class="btn btn-primary"><i class="fa fa-plus"></i> Seam</a>
                        <?php }?>
                    </div>
                </div>
            </div>
