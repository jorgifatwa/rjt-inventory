<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Shift Kerja Pengguna</h1>
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Shift Kerja Pengguna</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-sm-12 text-right">
            <?php if ($is_can_create) {?>
              <a href="<?php echo base_url() ?>user_shift/create" class="btn btn-primary"><i class="fa fa-plus"></i> Shift Kerja Pengguna</a>
            <?php }?>
          </div>
        </div>
      </div>
