                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" type="text" id="name" name="name" autocomplete="off" required placeholder="Nama Blok">
                                </div>
                            </div>
                        </div>
                    </div>
