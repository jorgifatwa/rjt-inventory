<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Coal Plan Baru</h1>
        <p class="m-0">Coal Plan</p>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="<?php echo base_url() ?>coal_plan"></i>Coal Plan</a></li>
          <li class="breadcrumb-item active">Coal Plan Baru</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-2">
                        ...
                        <select class="location_id" name="location_id" id="location_id">
		...
		?>
                ...
                <div class="row" style="margin-top:1%">
                    <div class="col-sm-12 text-right">
                        <a href="<?php echo base_url() ?>coal_plan" class="btn btn-danger">Batal</a>
