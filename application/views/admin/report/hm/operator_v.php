<section class="content-header">
    <h1>
        Grafik Per Bulan Berdasarkan Operator
        <small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><?php echo ucwords(str_replace("_", " ", $this->uri->segment(1))) ?></li>
        <li class="active">Grafik Per Bulan Berdasarkan Operator</li>    
    </ol>
</section>
...
<section class="content">
    ...
    <div class="box mb-3">
        ...
        <div class="box-body">
            ...
            <div id="grafik_operator"></div>
        </div>
    </div>
</section>

 <script data-main="<?php echo base_url() ?>assets/js/main/main-hm-operator" src="<?php echo base_url() ?>assets/js/require.js"></script>