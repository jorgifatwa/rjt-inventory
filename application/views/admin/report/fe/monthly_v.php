<section class="content-header">
    <h1>
        Data Fleet Event Per Bulan
        <small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><?php echo ucwords(str_replace("_", " ", $this->uri->segment(1))) ?></li>
        <li class="active">Data Fleet Event Per Bulan</li>    
    </ol>
</section>
...
<section class="content">
 ...
 <script data-main="<?php echo base_url() ?>assets/js/main/main-fe-monthly" src="<?php echo base_url() ?>assets/js/require.js"></script>