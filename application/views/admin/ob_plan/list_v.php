		...
		?>
                    ...
                    <div class="col-sm-4">
                        <div class="text-right">
                            <!-- <a href="<?php echo base_url() ?>plan/exportExcel" class="btn btn-info btn-sm btn-export">Export</a> -->
                            <!-- <a href="<?php echo base_url() ?>plan/import" class="btn btn-info btn-sm">Import</a> -->
                            <?php if ($is_can_create) {?>
                            <a href="<?php echo base_url() ?>ob_plan/create" class="btn btn-primary"><i class="fa fa-plus"></i> OB Plan</a>
                            <?php }?>
                        </div>
                    </div>
                </div>
