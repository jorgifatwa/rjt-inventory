            ...
            <form id="form" method="post">
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input class="form-control" type="text" id="name" name="name" autocomplete="off" placeholder="Nama Material">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="form-label col-sm-3" for="">Kapasitas</label>
                        <div class="col-sm-2">
                            <input class="form-control number" type="text" id="capacity" name="capacity" autocomplete="off" placeholder="Kapasitas">
                        </div>
                        <div class="col-sm-2">
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-sm-12 text-right">
                            <a href="<?php echo base_url() ?>material" class="btn btn-danger">Batal</a>
