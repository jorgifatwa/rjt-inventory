...
class Migration_Install_ion_auth extends CI_Migration {
	...
	public function up() {
		...
		$data = array(
			...
			array(
				'name'        => 'Operator Gudang A',
				'description' => 'Operator Barang di Gudang A'
			),
			array(
				'name'        => 'Operator Gudang B',
				'description' => 'Operator Barang di Gudang B'
			),
			array(
				'name'        => 'Owner',
				'description' => 'Owner'
